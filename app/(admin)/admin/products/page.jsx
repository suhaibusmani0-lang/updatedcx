      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            ...
            className="bg-[#1A1A1A] text-white px-4 py-2 rounded-lg hover:bg-[#AEAA9B] transition-colors flex items-center gap-2 whitespace-nowrap"
          >
            <Plus size={18} />
            Add Product
          </Link>
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#AEAA9B]"
          />
        </div>
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {filterStatus !== "all" && (
              <span className="bg-white text-[#AEAA9B] text-xs rounded-full px-2 py-0.5">
                1
              </span>
            )}
          </button>
          ...
          <div className="flex flex-wrap gap-4">
            <div>
              ...
              <select
                ...
                className="px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#AEAA9B] bg-white"
              >
                ...
                <td colSpan={8} className="text-center p-8">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    {(searchTerm || filterStatus !== "all") && (
                      <button
                        onClick={clearFilters}
                        className="text-sm text-[#AEAA9B] hover:underline"
                      >
                        Clear filters
                      </button>
                    )}
                ...
                <tr key={item._id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-3">
                    <div>
                      ...
                      {item.badge && (
                        <span className="inline-block text-[10px] px-1.5 py-0.5 bg-[#AEAA9B] text-white rounded mt-1">
                          {item.badge}
                        </span>
                      )}
                    </div>
                  ...
                  <td className="p-3">
                    <div className="flex items-center gap-1.5">
                      <Link
                        ...
                        className="p-1.5 text-gray-600 hover:text-[#AEAA9B] hover:bg-[#AEAA9B]/10 rounded transition-colors"
                        title="Edit product"
                      >
                        <Edit size={16} />
                      </Link>
