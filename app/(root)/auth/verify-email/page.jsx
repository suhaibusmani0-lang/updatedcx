...
function EmailVerificationContent() {
  ...
  return (
    <CardContent className="space-y-4 text-center">
      ...
      {status === "success" && (
        <Link href={WEBSITE_HOME} className="inline-flex items-center justify-center rounded-none bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90">
          Go to Home
        </Link>
      )}
    </CardContent>
