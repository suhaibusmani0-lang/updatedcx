  ...
  return (
    <div className="bg-white min-h-screen pb-16">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Top Image Section (First Photo - Sharp Edges) */}
        <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden mb-12 sm:mb-16">
          <Image
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-3xl mx-auto">
          ...
          >
            <h3 className="font-serif text-xl sm:text-2xl text-[#1A1A1A] mb-2 group-hover:text-[#AEAA9B] transition-colors">
              Email Us
            </h3>
            {/* Bold text class applied here */}
            <p className="text-sm sm:text-base tracking-[0.15em] text-[#1A1A1A] lowercase font-bold">
              b2b@cosmoxs.com
            </p>
          </a>
          ...
          >
            ...
            {/* Bold text class applied here */}
            <p className="text-sm sm:text-base tracking-[0.15em] text-[#1A1A1A] uppercase font-bold">
              +91 88823 53728
            </p>
          </a>
