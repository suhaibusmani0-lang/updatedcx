      ...
      <div className="max-w-md w-full bg-white rounded-2xl border border-[#E3D9C9] p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-[#1A1A1A] text-white text-xs tracking-widest uppercase rounded-xl hover:bg-[#AEAA9B] transition-colors"
          >
            <ShoppingBag size={14} />
            View Orders
          </Link>
          <Link
            href="/"
            className="px-6 py-3 border border-[#E3D9C9] text-[#1A1A1A] text-xs tracking-widest uppercase rounded-xl hover:border-[#AEAA9B] transition-colors"
          >
            Continue Shopping
          </Link>
        </div>
