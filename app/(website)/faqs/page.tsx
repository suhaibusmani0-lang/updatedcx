          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="text-gray-700 space-y-3">
                ...
                <p>Even after this if you are not fully satisfied with your purchase, don’t worry as we have an excellent Return policy. The process is pretty simple. All you need to do is raise a return request, within a period of “07 day”, from the date of delivery (48 hours for damaged and defective) following the below steps:</p>
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-3">
                ...
                <ul className="list-decimal pl-6 space-y-1">
                  <li>Raise a return request by calling our customer number at 8595124718 or by sending us the return request mail on our customer support email id support@cosmoxs.com.</li>
            ...
            <div>
              ...
              <div className="text-gray-700 space-y-3">
                ...
                <p>In this, the order amount will be remitted back to your card or net-banking account. The process for initiating this takes 3-4 business days however it may take approximately 3-5 business days to get the amount reflect in your card / net-banking account.</p>
                
                <h4 className="font-semibold text-black mt-4">Cash On Delivery Order</h4>
                <p>If you have placed an order using cash on delivery mode and had requested a refund: We take your bank account details along with a copy of the cancelled cheque and we do a bank transfer. In this, the money will get credited in your account within 3-5 working days.</p>
