...
export default async function ProductPage({
  ...
  return (
   <div className="min-h-screen bg-white text-[#1A1A1A]">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        {/* Main Product Layout */}
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-8 mb-8 relative">
 ...
 <div className="w-full lg:w-[40%] flex flex-col pt-4">
            <div className="flex flex-col mb-4">
              ...
              {product.sku && (
                <p className="text-sm text-black-400 mt-2 font-medium tracking-wide">
                  SKU: <span className="text-black-700">{product.sku}</span>
                </p>
              )}
            </div>
            ...
            {product.shortDescription && (
              <div className="relative mb-6">
                ...
                <label 
                  ...
                  className="inline-block mt-2 mb-10 text-sm font-semibold cursor-pointer underline peer-checked:hidden hover:text-gray-600 transition-colors"
            ...
            <div className="flex flex-col mb-8 mt-2">
              <div className="flex items-center gap-3">
                <span className="text-[22px] font-medium text-[#C1121F]">
                  ₹{price.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </span>
                {product.salePrice && product.price > product.salePrice && (
                  <>
                    <span className="text-[18px] text-gray-500 relative">
                      ₹{product.price.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      <span className="absolute left-0 top-[55%] w-full h-[1.5px] bg-[#C1121F] -rotate-[8deg] transform origin-center"></span>
                    </span>
                    <span className="text-[11px] font-medium px-2 py-1 border border-gray-300 text-gray-800 tracking-wider ml-1">
              ...
              <p className="text-[13px] text-gray-600 mt-1">Tax included.</p>
            </div>

            {/* Product Actions (size/color selectors, add to cart) */}
            <ProductActions
        ...
        <div className="max-w-4xl mx-auto space-y-2 py-2 border-t border-slate-200">
            ...
            {product.description ? (
              <div className="relative">
                ...
                <label 
                  ...
                  className="inline-block mt-4 mb-10 text-sm font-bold cursor-pointer underline peer-checked:hidden transition-colors"
                  style={{ color: "#000000", opacity: 1 }}
                >
