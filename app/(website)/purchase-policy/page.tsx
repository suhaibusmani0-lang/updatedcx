...
export default function TermsAndConditions() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 text-gray-800 font-justify">
      <h1 className="text-3xl font-bold mb-8 text-black">Order Placement And Pricing Terms</h1>

      <div className="space-y-8 leading-relaxed">
        
        <section>
          <h2 className="text-xl font-semibold mb-3 text-black">1. Order</h2>
          <div className="space-y-3 text-gray-700">
            ...
            <p>1.2 We sell products only to end-users.</p>
            <p>1.3 We will confirm your order that is placed directly by using the www.cosmoxs.com Site by message on the Site immediately after you have confirmed your order and by sending an e-mail to the e-mail address you have provided to us or mobile number you have provides to us.</p>
            <p>1.4 Please note that the order confirmation does not constitute our acceptance of your order. Subject to our cancellation rights, acceptance of your order and completion of the order will take place when we despatch the products to you.</p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-black">2. Product Pricing</h2>
          <div className="space-y-3 text-gray-700">
            <p>2.1 The prices stated on the Site will be inclusive of any GST payable.</p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-black">3. Payment Options</h2>
          <div className="space-y-3 text-gray-700">
            <p>3.1 Payment may be made by cash, debit card, credit card, internet banking and some wallets. You cannot pay for your order by cheque.</p>
            <p>3.2 The debit, credit and charge cards accepted by us are those listed on the Site on the date on which your order is placed. We do not save any data related to net banking, credit card, debit card, wallets etc. of any of our customers.</p>
          </div>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-3 text-black">4. Shipment of Products</h2>
          <div className="space-y-3 text-gray-700">
            <p>4.1 Delivery days and times will be as specified on the delivery booking page on the Site and will be made to the address specified by you when you place an order on the Site. We reserve the right to restrict deliveries in certain areas, and this includes the right to eliminate certain areas from our delivery schedule altogether.</p>
            ...
            <p>4.4 We take special care to endeavor that deliveries are made on time and accordingly, it is your responsibility to ensure that an appropriate person is available at the delivery address at all times during the delivery day. We may ask that an appropriate person signs for the products on delivery.</p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-black">5. Out of Stock Situations</h2>
          <div className="space-y-3 text-gray-700">
            <p>Our endeavour is to ensure that all products listed on the Site are available in stock for dispatch to You. However, in case this in not available for any reason, we will contact you and give you the option for order cancellation in case of COD orders and refund in case of prepaid orders as per your convenience.</p>
          </div>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-3 text-black">6. Product returns</h2>
          <div className="space-y-3 text-gray-700">
            <p>6.1 We advise that you inspect the products promptly at the time of delivery and installation and notify us of any defects promptly. If you discover a product is faulty, please call our Customer Service team as soon as possible on 8595124718 (Mon – Sat, 10:00 – 18:00 IST) or email us at support@cosmoxs.com for best possible action to resolve the issue.</p>
            <p>6.2 To return any items that are damaged, defective or not as per your original order, you can refer to our Returns Policy.</p>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-black">7. Customer Complaints</h2>
          <div className="space-y-3 text-gray-700">
            <p>7.1 Any customer complaints should be addressed to the Customer Service on 8595124718 (Mon – Sat, 10:00 to 18:00 IST) or email support@cosmoxs.com for the best possible action to resolve the issue.</p>
          </div>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-3 text-black">8. Severability</h2>
          <div className="space-y-3 text-gray-700">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3 text-black">9. Submissions</h2>
          <div className="space-y-3 text-gray-700">
