...
// Delhi-adjacent states — 3-5 days delivery
...
function computeEstimate(state) {
  ...
  if (NEARBY_STATES.has(s)) {
    return { minDays: 5, maxDays: 7, label: "3-5 business days" };
  }
  return { minDays: 7, maxDays: 9, label: "3-5 business days" };
}
  ...
  try {
    ...
    if (!details) {
      ...
      return jsonRes(200, "Delivery estimate available", {
        ...
        city: null,
        state: null,
        estimate: { minDays: 7, maxDays: 9, label: "3-5 business days" },
