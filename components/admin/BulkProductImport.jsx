...
const COLUMNS = [
  { header: "Name",              required: true,  hint: "Any text",                                      example: "Black Metal Burner" },
  { header: "Root Category",     required: true,  hint: "Must match an existing root category",          example: "Bakhoor & Incense Burners" },
  { header: "Sub Category",      required: false, hint: "Must match an existing sub-category (optional)",example: "Metal Bakhoor Burners" },
  ...
  { header: "Sizes",             required: false, hint: "Comma separated (e.g., S, M, L)",               example: "Standard, Large" }, 
  { header: "Colors",            required: false, hint: "Comma separated (e.g., Red, Blue)",             example: "Black, Gold" }, 
  { header: "Description",       required: false, hint: "Long text",                                     example: "Premium metal burner." },
  { header: "Short Description", required: false, hint: "Short text",                                    example: "Great for gifting." },
  { header: "Badge",             required: false, hint: "Any text e.g. New, Sale",                       example: "New Arrival" },
    ...
    <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm space-y-5">
      ...
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-lg px-5 py-2.5 text-sm font-semibold text-white transition-colors ${
          uploading || !file ? "bg-gray-400 cursor-not-allowed" : "bg-[#1A1A1A] hover:bg-[#AEAA9B]"
        }`}
      >
        <UploadCloud size={16} />
