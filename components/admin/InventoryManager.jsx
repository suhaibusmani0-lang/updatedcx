  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex items-center gap-2">
        <Package className="h-5 w-5 text-[#AEAA9B]" />
        <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <textarea
          ...
          className="w-full rounded-lg border border-gray-300 p-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#AEAA9B]"
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex items-center gap-2 rounded-lg bg-[#1A1A1A] px-4 py-2 text-sm text-white hover:bg-[#AEAA9B] disabled:opacity-50"
        >
