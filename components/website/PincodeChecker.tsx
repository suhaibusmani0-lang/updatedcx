  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 text-sm font-medium text-[#1A1A1A] mb-3">
        <MapPin size={16} className="text-[#AEAA9B]" />
      ...
      <form onSubmit={handleCheck} className="flex items-stretch gap-2">
        <input
          ...
          className="flex-1 min-w-0 border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#AEAA9B] focus:border-[#AEAA9B]"
        ...
        <button
          ...
          className="bg-[#1A1A1A] text-white px-5 py-3 rounded-lg text-sm font-medium hover:bg-[#AEAA9B] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
        >
        ...
        >
          ...
          <div className="text-sm text-[#1A1A1A]">
            ...
            <p className="mt-1 flex items-center gap-1.5 text-[#1A1A1A]/70">
              <Truck size={14} className="text-[#AEAA9B]" />
