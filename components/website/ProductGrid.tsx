...
function EmptyState() {
  return (
    <div className="text-center py-12">
      ...
      <p className="text-sm text-[#6F5638]">Check back later for new arrivals</p>
    </div>
  );
}
    ...
    <section className="bg-[#FAF7F2] py-2 lg:py-2 border-t border-[#E3D9C9]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-10">
        <div className="flex items-center justify-center mb-2 text-center">
          <div>
            <p className="text-[10px] sm:text-xs tracking-[0.3em] uppercase text-[#6F5638] font-bold mb-1 sm:mb-2">
              {subtitle}
            </p>
        ...
        {viewAllLink && products.length > 0 && (
          <div className="mt-8 text-center sm:hidden">
            <a
              href={viewAllLink}
              className="text-[11px] font-bold tracking-widest uppercase text-[#1A1A1A] border-b border-[#1A1A1A] pb-0.5 hover:text-[#6F5638] hover:border-[#6F5638] transition-colors"
            >
              View All
            </a>
          </div>
      ...
      <div className="flex items-center justify-center mb-2 mt-4 text-center">
        {viewAllLink && (
          <a
            href={viewAllLink}
            className="hidden sm:inline text-[11px] font-bold tracking-widest uppercase text-[#1A1A1A] border-b border-[#1A1A1A] pb-0.5 hover:text-[#6F5638] hover:border-[#6F5638] transition-colors whitespace-nowrap"
          >
            View All
          </a>
        )}
